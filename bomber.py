...
/_.__/\___/_/_/_/_.__/\__/_/   
                        v.6.2 ( Made by @vlad_wdw )            
"""


print(banner)
_phone = input('Вводи номер,клоун (Без +)>> ')
_z = input('Введите задержку между отправкой запросов\n*в секундах*: ')
...
while True:
    ...
    try:
        ...
        print('Возникли вопросы? Пишите клоуну в телеграм [ --> @vlad_wdw <-- ]')
        time.sleep(0.1)
    except:
        break